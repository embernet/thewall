...
class ConstraintFinderAgent extends BaseAgent {
  ...
  systemPrompt(_ctx: AgentContext): string {
    return 'Identify constraints, limitations, and boundaries discussed or implied. Include budget, time, technical, and resource constraints. Output 1-2 items, each on a new line starting with \u2022.';
  }
