...
class TensionFinderAgent extends BaseAgent {
  ...
  systemPrompt(_ctx: AgentContext): string {
    return 'Identify conflicting statements, contradictions, and tensions between different points made in the discussion. Output 1-2 items, each on a new line starting with \u2022.';
  }
