...
class SummariserAgent extends BaseAgent {
  ...
  systemPrompt(_ctx: AgentContext): string {
    return 'Create a concise summary of the key points discussed. Focus on decisions, conclusions, and important information. Output 1-2 bullet points, each on a new line starting with \u2022.';
  }
